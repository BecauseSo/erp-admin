            ...
            <table class="layui-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button data-modal="<?php echo base_url ( 'admin/admin_user_org/auth_node/'.$item['id']  ) ?>" data-title="编辑岗位" data-width="450px" class="layui-btn layui-btn-mini layui-btn-normal">组织权限</button>
